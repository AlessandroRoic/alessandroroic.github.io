<template>
  <BaseSection id="about" data-observable>
    ...
    <div class="about__summary">
      <img class="about__side-photo" alt="profile" :src="profile" aria-label="profile picture" />
      <div class="m-auto">
    ...
    <div class="section__pill-wrapper">
      <div v-for="skill in skills" :key="skill" class="section__pill">
        {{ skill }}
      </div>
    </div>
    <hr class="mx-2" />
    ...
    <div>
      I aspire to be a Game Developer and it has been a dream of mine since I've realized how games make people engaged and passionate, and
      I always wanted to make something that would create that effect.
    </div>
  </BaseSection>
</template>
...
import { downloadCv } from '../../helpers/utils';
